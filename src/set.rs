...
pub type Iter<'a, T> = <<T as Key<'a, ()>>::SetStorage as SetStorage<'a, T>>::Iter;

/// The iterator produced by [`Set::into_iter`].
pub type IntoIter<'a, T> = <<T as Key<'a, ()>>::SetStorage as SetStorage<'a, T>>::IntoIter;
